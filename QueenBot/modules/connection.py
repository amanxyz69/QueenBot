...
import QueenBot.modules.sql.connection_sql as sql
from QueenBot import DEV_USERS, DRAGONS, dispatcher
from QueenBot.modules.helper_funcs import chat_status
