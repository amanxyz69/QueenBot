...
# from QueenBot.modules.sql import warns_sql as warnssql
import QueenBot.modules.sql.blacklist_sql as blacklistsql

# from QueenBot.modules.sql import cust_filters_sql as filtersql
# import QueenBot.modules.sql.welcome_sql as welcsql
import QueenBot.modules.sql.locks_sql as locksql
import QueenBot.modules.sql.notes_sql as sql

# from QueenBot.modules.rules import get_rules
import QueenBot.modules.sql.rules_sql as rulessql
from QueenBot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from QueenBot.__main__ import DATA_IMPORT
from QueenBot.modules.connection import connected
from QueenBot.modules.helper_funcs.alternate import typing_action
from QueenBot.modules.helper_funcs.chat_status import user_admin
from QueenBot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("QueenBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("QueenBot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `QueenBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("QueenBot{}.backup".format(chat_id))  # Cleaning file
