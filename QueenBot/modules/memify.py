...
from QueenBot import telethn as bot
from QueenBot.events import register

Credit = "Venom_bolte_public"
...
async def handler(event):
    ...
    if "Venom_bolte_public" in Credit:
        pass
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./QueenBot/resources/default.ttf"
