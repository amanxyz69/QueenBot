...
import QueenBot.modules.sql.userinfo_sql as sql
...
from QueenBot import telethn as VenomTelethonClient
from QueenBot.__main__ import STATS, TOKEN, USER_INFO
from QueenBot.modules.disable import DisableAbleCommandHandler
from QueenBot.modules.helper_funcs.chat_status import sudo_plus
from QueenBot.modules.helper_funcs.extraction import extract_user
from QueenBot.modules.sql.afk_sql import check_afk_status, is_afk
from QueenBot.modules.sql.global_bans_sql import is_user_gbanned
from QueenBot.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/Its_Venom_family"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/Its_Venom_family"
                            ),
                        ],
                    ]
                ),
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Umm... yeah, I only trust Venom to set my bio."
            )
            return
