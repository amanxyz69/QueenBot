...
import QueenBot.modules.sql.global_bans_sql as gban_sql
import QueenBot.modules.sql.users_sql as user_sql
from QueenBot import DEV_USERS, OWNER_ID, dispatcher
