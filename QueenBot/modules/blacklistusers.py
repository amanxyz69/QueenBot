...
import QueenBot.modules.sql.blacklistusers_sql as sql
from QueenBot import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from QueenBot.modules.helper_funcs.chat_status import dev_plus
